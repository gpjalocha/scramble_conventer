...
cubestring = "DUUDUDLFLBBRFRRDLFUDUFFRDULRFBBDBDDRLRFRLLRUBBLFUBBULF"  # cube definition string of cube we want to solve
...
import solver as sv
import cubie as cb
a = sv.solve(cubestring, 25, 1)  # solve with a maximum of 20 moves and a timeout of 2 seconds for example
print(a)
quit()
########################################################################################################################
